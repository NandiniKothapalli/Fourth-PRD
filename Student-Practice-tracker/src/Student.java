public class Student {
    ...
    this.completedTopics=newlyCompletedTopics+this.completedTopics;
    }
    void addQuestions(int newQueSolved){
        this.questionsSolved=newQueSolved+this.questionsSolved;
    }
